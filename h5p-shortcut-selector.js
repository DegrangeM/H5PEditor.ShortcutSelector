...
H5PEditor.widgets.shortcutSelector = H5PEditor.shortcutSelector = (function ($) {
  ...
  C.prototype.appendTo = function ($wrapper) {
    ...
    this.$item.find('button').click(function () {
      that.$inputs.eq(0).val('').data('register-shortcut', true).prop('disabled', false).focus();
    ...
    this.$inputs.eq(0).keydown(function (e) {
      ...
      if ($(this).data('register-shortcut')) {
      ...
      if ($(this).data('register-shortcut')) {
        ...
        $(this).data('register-shortcut', false).prop('disabled', true);
  ...
  C.prototype.createHtml = function () {
    ...
    const shortcutInput = H5PEditor.createText(this.params !== undefined ? this.params.keys : undefined, undefined, 'Shortcut' /* TODO C.t('clickToSet') */, id, descriptionId);
    ...
    const input = '<div class="h5p-shortcut-selector-shortcut"><button type="button" class="h5peditor-button-textual">Set shortcut</button>' /* TODO */ + shortcutInput + shortcutTextInput + '</div>';
